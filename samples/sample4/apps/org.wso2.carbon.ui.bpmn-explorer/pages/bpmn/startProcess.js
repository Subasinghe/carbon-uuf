function onRequest(context) {
    ...
    if(str.indexOf("&") == -1) {
        var processInstanceData = callOSGiService("org.wso2.carbon.ui.bpmn_explorer.service.BPMNExplorerService", "getFormData", [str.split("=")[1], context.app.config.bpsHost,context.app.config.bpsPort]);
        ...
        var processInstanceDataForm = callOSGiService("org.wso2.carbon.ui.bpmn_explorer.service.BPMNExplorerService", "createProcessInstanceWithData", [context.request.queryString, context.app.config.bpsHost,context.app.config.bpsPort]);
